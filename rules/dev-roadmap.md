...
| done | Implement compact-overlay controls: position, separate five-step window/UI sizes, and persisted 4~7 column / 4~6 row limits with automatic layout. | Isolated Release build; focused settings/layout tests |
