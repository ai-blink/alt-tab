...
| next | Implement approved compact-overlay Option 1: position plus separate five-step window and UI sizes with automatic card layout. | Approved mock, `notes/mocks/2026-08-09_compact-overlay-controls/` |
