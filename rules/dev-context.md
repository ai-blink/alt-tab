...
- Date: 2026-08-17
- Current slice: `v0.3.0` Portable release published for the approved settings-window overhaul and persistent overlay position.
...
- Immediate next step: complete the user UI check for the unclipped settings modal plus 60/70/100/200%, Grid/Compact/List, drag persistence, 10 remote actions, and modal close/focus behavior.
