...
- Verification: Release build passes with 0 warnings/errors; 41 tests pass; the reported 23-window/100%/1.1x compact layout is covered by a focused regression.
- Runtime state: the new Release build is running; visual confirmation of the fixed fourth column remains the active user UI smoke step.
