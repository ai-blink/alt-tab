...
- Date: 2026-08-19
- Current slice: post-release UI acceptance for the published `v0.3.1` Portable settings-sidebar patch.
...
- Last verified: 2026-08-18 `v0.3.1` Release build has 0 warnings/errors and all 57 tests pass. The public GitHub release contains one self-contained `win-x64` ZIP whose SHA-256 matches the local package.
- Immediate next step: complete the user UI check for the settings sidebar status card, then verify 60/70/100/200%, Grid/Compact/List, drag persistence, all 9 directional moves plus saved-position return, and modal close/focus behavior.
