...
- Date: 2026-08-17
- Current slice: `v0.3.0` release preparation for the approved settings-window overhaul and persistent overlay position.
...
- Last verified: 2026-08-17 `v0.3.0` Release build has 0 warnings/errors and all 57 tests pass. The self-contained `win-x64` ZIP contains only `Switchboard.App.exe` and `읽어주세요.txt`.
- Immediate next step: publish the prepared `v0.3.0` Portable ZIP, then complete the user UI check for the unclipped settings modal plus 60/70/100/200%, Grid/Compact/List, drag persistence, 10 remote actions, and modal close/focus behavior.
